# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-12-30 21:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('txn_type', models.CharField(choices=[('load-wallet', 'load wallet'), ('payment', 'payment'), ('wallet-payment', 'wallet payment')], max_length=32)),
                ...
                ('amount', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, max_digits=10, null=True)),
            ],
            options={
